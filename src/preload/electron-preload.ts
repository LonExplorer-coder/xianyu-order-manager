...
const api: DesktopApi = {
  ...
  verifyBackup: () => ipcRenderer.invoke('backup:verify'),
  restoreBackup: () => ipcRenderer.invoke('backup:restore'),
  getBackupSettings: () => ipcRenderer.invoke('backup:get-settings'),
  saveBackupSettings: (input) => ipcRenderer.invoke('backup:save-settings', input),
  selectBackupRoot: (purpose) => ipcRenderer.invoke('backup:select-root', purpose),
